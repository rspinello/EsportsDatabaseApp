...
--Tournament
INSERT INTO TOURNAMENT VALUES('Intel Extreme Masters','07-21-2019','CSGO','Liquid');
INSERT INTO TOURNAMENT VALUES('RLCS Season X – Fall','09-10-2020','RocketLeague','G2Esports');
...
select * from REGISTERED_USERS where USERID = 'bdugan';

commit;

select * from PLAYER ORDER BY TOURNAMENT_WINS DESC;
